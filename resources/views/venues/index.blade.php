                    ...
                    <tr>
                        ...
                        <td class="d-flex justify-content-center">
                            <button class="btn btn-primary mr-2">
                                <a style="text-decoration: none; color: white" href="{{ route('venues.show',$venue->id) }}"><i class="fa fa-eye"></i></a>
                            </button>
                            <button class="btn btn-success mr-2">
                                <a style="text-decoration: none; color: white" href="{{ route('venues.edit',$venue->id) }}"><i class="fa fa-pencil"></i>
                                </a>
                            </button>
